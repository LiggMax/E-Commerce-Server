...
CREATE TABLE `carousel` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_cs_0900_ai_ci COMMENT='轮播图';
...
CREATE TABLE `featured_products` (
  `id` bigint NOT NULL,
  `name` char(30) NOT NULL COMMENT '商品名称',
...
-- Dump completed on 2025-09-27 10:09:27
